...
enum class UniversalScanAction { CHECKOUT_COPY, RETURN_COPY, REGISTER_ISBN, CATALOG, MANUAL_SEARCH }

/** Camera identifies physical copies or book ISBNs only; circulation requires explicit confirmation. */
